...
<head>
    ...
    <link rel="stylesheet" href="css/administrator/responsite.css">
    <link rel="stylesheet" href="css/administrator/teacher_functionality/teacher.css">
...
<body>
        ...
        <ul class="nav-menu">
                ...
                <li>
                    <a href="javascript:void(0)" onclick="showSection('batches', event)">
                        ...
                        <span>Batches, Departments & Subjects</span>
                    </a>
                </li>
                <li>
    ...
    <div class="main-content">
        ...
        <!-- Import Students Section end -->


        <!-- Import Results Section start-->
        ...
        <!-- Import Results Section end-->


        <!-- Manage Results Section (Teachers Only) Start -->
            <?php if (!isAdmin()): ?>
        ...
        <!-- Manage Results Section (Teachers Only) end -->
        ...
        <!-- Manage Teachers Section End-->


        <!-- Batches & Departments Section Start-->
            ...
            <div id="batches" class="page-section">
                <div class="row g-4">
                    ...
                    <div class="col-lg-12">
                        <div class="content-card">
                            <h4><i class="bi bi-book-fill me-2"></i>Manage Subjects</h4>
                            <form class="form-modern mb-4" id="addSubjectQuickForm">
                                <div class="mb-2">
                                    <input type="text" name="subject_code" class="form-control form-control-sm" placeholder="Subject Code" required>
                                </div>
                                <div class="mb-2">
                                    <input type="text" name="subject_name" class="form-control form-control-sm" placeholder="Subject Name" required>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    <input type="number" name="total_marks" class="form-control form-control-sm" placeholder="Total Marks" value="100" min="1" required>
                                </div>
                                <button class="btn btn-warning w-100 btn-sm" type="submit">
                            ...
                            <div style="max-height: 400px; overflow-y: auto;">
                                <div class="mb-3">
                                    <select class="form-select form-select-sm" id="subjectQuickFilter" onchange="loadSubjectsQuick()">
                                        <option value="">All Subjects</option>
                                        <?php foreach ($departments as $dept): ?>
                                            <option value="<?php echo $dept['id']; ?>"><?php echo htmlspecialchars($dept['code']); ?></option>
                                        <?php endforeach; ?>
                                ...
                                <div class="list-group" id="subjectsQuickList">
        ...
        <!-- Batches & Departments Section End-->
    ...
    <script src="js/administrator/admin_functionality/batches_departments_subjects.js"></script>
    <?php if (!isAdmin()): ?>
    ...
    <script>
        ...
        function showSection(sectionId, event) {
            ...
            const titles = {
                ...
                'settings': 'Settings',
                'batches': 'Batches, Departments & Subjects',
                'reports': 'Reports'
            };
