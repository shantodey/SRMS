...
<head>
    ...
    <link rel="stylesheet" href="css/index/notices.css">
...
<body>
    ...
    <!-- Notice Cards Section (Desktop) / Notice Buttons (Mobile) end -->
    ...
    <!-- View All Notices Button start -->
        <div class="bbk-view-all-container">
            <button class="bbk-view-all-notices-btn" onclick="openAllNoticesModal()">
                <div class="bbk-view-all-icon">
                    <i class="bi bi-grid-3x3-gap-fill"></i>
                </div>
                <div class="bbk-view-all-content">
                    <span class="bbk-view-all-title">View All Notices</span>
                    <span class="bbk-view-all-subtitle" id="totalNoticesCount">Loading...</span>
                </div>
                <div class="bbk-view-all-arrow">
                    <i class="bi bi-arrow-right-circle-fill"></i>
                </div>
            </button>
        </div>
    <!-- View All Notices Button end -->

    <!-- All Notices Modal start-->
        <div id="allNoticesModal" class="bbk-all-notices-modal" style="display: none;">
            <div class="bbk-all-notices-overlay" onclick="closeAllNoticesModal()"></div>
            <div class="bbk-all-notices-container">
                <div class="bbk-all-notices-header">
                    <h2 class="bbk-all-notices-title">
                        <i class="bi bi-bell-fill me-2"></i>All Notices
                    </h2>
                    <button type="button" class="bbk-notice-modal-close" onclick="closeAllNoticesModal()" aria-label="Close">
                        <i class="bi bi-x-lg"></i>
                    </button>
                </div>
                <div class="bbk-all-notices-body" id="allNoticesBody">
                    <!-- Notices will be loaded here -->
                </div>
                <div class="bbk-all-notices-footer" id="loadMoreSection" style="display: none;">
                    <button type="button" class="btn btn-login" onclick="loadMoreNotices()">
                        <i class="bi bi-arrow-down-circle me-2"></i>Load More Notices
                    </button>
                </div>
            </div>
        </div>
